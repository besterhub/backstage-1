...
/**
 * Matches an entity against either a string reference or a compound reference.
 *
 * The matching is case insensitive, and all of kind, namespace, and name must
 * match (after applying the optional context to the ref).
 *
 ...
 */
export function matchEntityWithRef(
  entity: Entity,
